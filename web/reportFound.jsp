...
<html lang="en">
    <head>
        ...
        <style>
            ...
            button { border: none; background: #198754; color: #fff; padding: 10px 16px; border-radius: 8px; cursor: pointer; }
        ...
        <div class="container">
            <div class="card">
                ...
                <form id="foundForm" action="${pageContext.request.contextPath}/report" method="post" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="actions">
                        <button id="submitFoundBtn" type="submit">Submit Found Report</button>
